      ...
      <div class="card-body">
        <div class="card-content p-2">
          <div class="text-center">
            <img src="<?php echo base_url('assets/admin/images/logo-icon.png'); ?>" alt="logo icon">
          </div>
          ...
          <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
            ...
            <div class="form-group">
              ...
              <div class="position-relative has-icon-right">
                <input type="text" id="exampleInputUsername" name="user" class="form-control input-shadow" placeholder="Enter Username  Or Email" required>
